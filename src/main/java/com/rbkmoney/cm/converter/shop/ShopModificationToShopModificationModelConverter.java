...
@Component
public class ShopModificationToShopModificationModelConverter
        implements ClaimConverter<ShopModification, ShopModificationModel> {
        ...
        switch (shopModification.getSetField()) {
            ...
            case CONTRACT_MODIFICATION:
                return conversionService
                        .convert(shopModification.getContractModification(), ShopContractModificationModel.class);
            case DETAILS_MODIFICATION:
                return conversionService
                        .convert(shopModification.getDetailsModification(), ShopDetailsModificationModel.class);
            case CATEGORY_MODIFICATION:
                return conversionService
                        .convert(shopModification.getCategoryModification(), ShopCategoryModificationModel.class);
